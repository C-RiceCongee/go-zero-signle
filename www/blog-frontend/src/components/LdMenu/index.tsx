...
const LdMenu = () => {
	...
	return (
		<div className='LdMenu'>
			...
			<header className={`mobile-menu bg-skin-menu-bg duration-100 sticky top-0 text-skin-menu-content backdrop-blur md:hidden  ${open ? 'h-lvh fixed' : 'h-[64px]'} overflow-hidden  pt-5 pb-5`}>
